 ...
 <header>
   ...
   <main class="mt-5 pt-5">
        ...
        if(isset($_GET['IdB'])){
            ...
            $parametros = array("NombreCliente"=> $_GET['NombreClienteB'] , "Apellidos"=> $_GET['ApellidosB'] , "IdCliente" => $_GET['IdClienteB']);
            $response = $client->__soapCall('AgregarCliente',array($parametros),);
...
<a href="indexAgregarCliente.php" class="login-forgot-pass1">Viajes Lupis</a>
